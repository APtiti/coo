...
<div class="card-body">
    <div class="row">
        <div class="col-lg-3 col-md->
            ...
            <input type="date" name="fecha" class="form-control" value="{{$pedido->fecha}}">
        </div>
    <div class="col-lg-3 col-md-3">
        <label for="form-label">Nota</label>
    <input type="text" class="form-control" name="nota" value="{{$pedido->nota}}">
    </div>
    <div class="col-lg-3 col-md-3">
        <label for="form-label">Subtotal</label>
    <input type="number" class="form-control" name="subtotal" value="{{$pedido->subtotal}}">
    </div>
