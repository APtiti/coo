                       ...
                       <div class="container-fluid">
                        <div class="row">
                            <div class="col-12 col-md-12 col-sm-12 col-xs-12">
                                <h1>Lista de topping</h1>
                                <a class="btn btn-primary" href="{{route('topping.create')}}" role="button">Crear</a>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <th>{{$toppings->id}}</th>
                                    <td>{{$toppings->nombre}}</td>
                                    <td>
                                        <a class="btn btn-primary" role="button" href="{{route('topping.show',$toppings->id)}}">ver</a>
                                        <a class="btn btn-success" role="button" href="{{route('topping.edit',$toppings->id)}}">editar</a>                       
                                    </td>
                                  </tr>
                                  @endforeach
                                </tbody>
