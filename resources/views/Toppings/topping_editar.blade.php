...
<body>
    ...
    <div class="row">
        <div class="col col-md-12 col-sm-12 justify-content-center">
            <font align="center"><h1>Formulario de topping</h1></font>
            <a class="btn btn-primary" href="{{route('topping')}}" role="button">Lista</a>
...
<div class="card-body">
    <div class="row">
        <div class="col-lg-3 col-md->
            ...
            <input type="text" name="nombre" class="form-control" value="{{$topping->nombre}}">
        </div>
