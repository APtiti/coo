                      ...
                      <div class="container-fluid">
                        <div class="row">
                            <div class="col-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <a class="btn btn-primary" href="{{route('usuario.create')}}" role="button">Crear</a>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary" role="button" href="{{route('usuario.show',$usuario->id)}}">ver</a>
                                        <a class="btn btn-success" role="button" href="{{route('usuario.edit',$usuario->id)}}">editar</a>                       
                                    </td>
                                  </tr>
                                  @endforeach
                                </tbody>
